...
publishing {
    ...
    publications.withType<MavenPublication> {
        artifact(javadocJar)
        pom {
            name.set("Compose Preferences Settings")
            description.set("A Compose library to emulate the style of Android preferences using Jetpack DataStore for Android and Preferences API for Java as backing.")
